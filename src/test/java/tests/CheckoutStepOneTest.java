...
public class CheckoutStepOneTest extends TestBase {
	...
	public void tc01_proceedWithValidDetails(String firstName, String lastName, String zip)
	...
	public void tc02_proceedWithInValidDetails(String firstName, String lastName, String zip)
			throws InterruptedException {
